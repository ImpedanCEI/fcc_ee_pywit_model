...
class FCCEEModel(Model):
    def __init__(self,
        ...
        # --------------------------------------------------------
        # Load FCC-ee collimation lattice (GHC optics V23)
        # --------------------------------------------------------
        sequence_name = 'ring'
        mad.call(os.path.join(
            base_dir,
            './fccee_collimation_lattice_forimpedance/FCCee_z_V23_tridodo572_colloptics_thin.seq'
        ))
        ...
        # Hard-coded tunes for GHC V23 (you provide these)
        self.q_x = 218.168
        self.q_y = 222.2
