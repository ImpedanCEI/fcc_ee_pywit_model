...
class FCCEEModel(Model):
    def __init__(self,
        ...
        # --------------------------------------------------------
        # Load FCC-ee collimation lattice (GHC optics V25.4)
        # --------------------------------------------------------
        sequence_name = 'ring'
        mad.call(os.path.join(
            base_dir,
            './fccee_collimation_lattice_forimpedance/FCCee_z_V25_4_GHC_tcp_tcs_tct.seq'
        ))
        ...
        # Hard-coded tunes for GHC V25.4 (you provide these)
        self.q_x = 214.1681055519011
        self.q_y = 214.1999272539314
