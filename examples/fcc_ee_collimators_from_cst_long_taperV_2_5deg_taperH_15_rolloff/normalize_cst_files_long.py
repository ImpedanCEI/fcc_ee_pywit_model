...
import_folder = "/home/dogibellieri/fcc_ee_pywit_model/examples/CST_results/Collimator_schematic/Longitudinal_taper_2_5deg_0_5rolloff"
output_folder = "/home/dogibellieri/fcc_ee_pywit_model/examples/fcc_ee_collimators_from_cst_long_15degH_2_5degV_wake_05rolloff/collimator_schematic_normalized_long_2_5deg_rolloff "
...
for filename in os.listdir(import_folder):
    ...
    if filename.startswith("Impedance"):
        ...
        table[:, 1] *= -1e3 # from V/pC to - V/C (we need to change the sign for the longitudinal wake to be coherent with the Xsuite convention)
        if "long" in filename:
            component = "wlong"
        else: 
            raise ValueError("No long found in filename")     
